package com.udea.gdrive.controller;
...
import com.udea.gdrive.dto.FileItemDTO;
...
public class HomepageController {
    ...
    private static final String USER_IDENTIFIER_KEY = "MY_DUMMY_USER1";
    ...
    public void createFile(HttpServletResponse response) throws Exception {
        ...
        FileContent content = new FileContent("image/jpeg", new java.io.File("C:\\Users\\santy\\IdeaProjects\\gdrive\\src\\main\\resources\\static\\images\\google_sign_in.png"));
    ...
    public void uploadFileInFolder(HttpServletResponse response) throws Exception {
        ...
        file.setParents(Arrays.asList("1Y_fhUKzWbJrySDq7UA_Sy54iRiJwLWK4"));
